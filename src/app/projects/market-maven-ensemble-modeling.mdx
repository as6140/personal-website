...
summary: "An AutoML system that stacks multiple ML models to forecast stock performance for the Magnificent 7 tech companies — a data science take on equity research."
images:
