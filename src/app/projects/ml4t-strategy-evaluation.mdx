...
summary: "Teaching a computer to trade JPM stock using deep reinforcement learning (Q-Learning & Dyna-Q), then stress-testing it against the 2008 financial crisis."
images:
